...
public class DaftarKelompokArisanIsiActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_kelompok_arisan_isi);
        ...
        for(int i = 1; i < num; i++){
            ...
            button.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(DaftarKelompokArisanIsiActivity.this, KatalogActivity.class);
